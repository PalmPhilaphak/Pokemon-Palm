...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BPTMOC6n.mjs').then((m) => m.default || m)
  },
  {
    name: "pokemon-id",
    path: "/pokemon/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CuIjSCZx.mjs').then((m) => m.default || m)
  },
  {
    name: "pokemon-list",
    path: "/pokemon/list",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./list-BZ2IrNAe.mjs').then((m) => m.default || m)
  }
];
